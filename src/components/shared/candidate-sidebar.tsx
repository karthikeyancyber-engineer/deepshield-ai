...
import {
  Shield, LayoutDashboard, Video, FileText, Calendar,
...
const navItems = [
  ...
  { href: "/dashboard/request-interview", label: "Request Interview", icon: Video },
  { href: "/dashboard/interview-history", label: "History", icon: Calendar },
        ...
        <div className="flex items-center gap-3">
          ...
          <AnimatePresence>
            {!collapsed && (
              ...
              >
                <p className="text-sm font-medium text-[var(--text-primary)] truncate">{user?.full_name || "Candidate"}</p>
